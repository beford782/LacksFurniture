...
const MUTATIONS = [
  ...
  ["1.3 containment: the drawer why-fit heading element returns",
    '        <div class="drawer-section-label" id="drawerDifferentiatorsLabel">Key features</div>',
  ...
  ["A3.1 drawer: the second trial prompt returns (the same trial explained twice)",
    "getMattressTrialPrompts(m).slice(0, 1).map(",
    "getMattressTrialPrompts(m).slice(0, 2).map(",
    A31],
