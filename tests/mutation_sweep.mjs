...
const MUTATIONS = [
  ...
  ["docked footer: the replacement notice, Undo and the live region leave the footer",
    ...
    A31],
  // --- Consolidation pass: the drawer title's focus treatment ----------------
  ["product-proof focus: the drawer title's author ring is removed (the UA rectangle returns)",
    "    .drawer-mattress-name:focus-visible {\n      width: -webkit-fit-content;\n      width: fit-content;\n      max-width: 100%;\n      outline: 3px solid var(--focus-ring-outer);\n      outline-offset: 5px;\n      box-shadow: 0 0 0 8px var(--focus-ring-inner);\n    }\n",
    "",
    A31_LAYOUT],
  ["product-proof focus: the name loses its clearance above (the ring crosses the brand line)",
    "color:var(--cream); margin:10px 0 6px; }",
    "color:var(--cream); margin:4px 0 6px; }",
    A31_LAYOUT],
  ["product-proof focus: the drawer title's focus is suppressed outright (outline: none)",
    "      outline: 3px solid var(--focus-ring-outer);\n      outline-offset: 5px;\n      box-shadow: 0 0 0 8px var(--focus-ring-inner);\n    }\n    @media (forced-colors: active) {\n      .drawer-mattress-name:focus-visible {",
    "      outline: none;\n      box-shadow: none;\n    }\n    @media (forced-colors: active) {\n      .drawer-mattress-name:focus-visible {",
    A31_LAYOUT],
  ["product-proof: the proof glyph loses aria-hidden",
    ...
    A31],
  ["product-proof: the drawer no longer paints the product proof (stale content survives navigation)",
    "      paintDrawerProductProof(m);\n",
    "      // paintDrawerProductProof(m);\n",
    A31],
