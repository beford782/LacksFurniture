...
const MUTATIONS = [
  ...
  ["A3.1 drawer: the construction chip addresses the customer again on the specialist worksheet",
    ...
    A31.concat(CONS)],
  ["A3.1 drawer: the step rings stop following the recorded reaction",
    "      var reacted = !!(mattressId && (window._mattressReactions || {})[mattressId]);\n      var chosenHere",
    "      var reacted = false;\n      var chosenHere",
    A31],
  ["A3.1 drawer: the step rings leave the wipe",
    "      { id: 'drawerNoticeLabel', remove: ['is-done', 'is-current'] },\n      { id: 'drawerReactionLabel', remove: ['is-done', 'is-current'] },\n      { id: 'drawerFinalistLabel', remove: ['is-done', 'is-current'] },\n",
    "",
    A31],
