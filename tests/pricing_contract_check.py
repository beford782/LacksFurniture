...
try:
    ...
    CASES = [
        ...
        # The build-time half of the currency rule the runtime gate mirrors
        # (Codex correction 2026-09-09): XXX is an ISO 4217 code Intl formats.
        ("entry currency XXX (Intl formats it; the governed set refuses it)",
         ("pricing", "products", 0, "price", "currency"), "XXX", "must equal pricing.currency"),
        ("contract currency XXX",
         ("pricing", "currency"), "XXX", "must be one of"),
        ("entry currency lower-case usd",
         ("pricing", "products", 0, "price", "currency"), "usd", "must equal pricing.currency"),
