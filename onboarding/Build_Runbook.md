...
- [ ] Profile screen shows the personalized opener (built from the sleep-fit answers; `current_mattress_age` and `sleep_quality` were removed from the quiz by owner ruling 2026-08-12 and `trigger` by the owner-approved A4.3 reduction, 2026-09-03)
